...
void RFM96WInit(RadioEvents_t *events)
{
    ...
    Radio.Write(REG_LR_PADAC, (RFM96WRead(REG_LR_PADAC) & RFLR_PADAC_20DBM_MASK | RFLR_PADAC_20DBM_OFF));
    ...
    Radio.Write(REG_OPMODE, (RFM96WRead(REG_OPMODE) & RFLR_OPMODE_FREQMODE_ACCESS_MASK | RFLR_OPMODE_FREQMODE_ACCESS_LF));

    //LNA gain set by the internal AGC loop
    Radio.Write(REG_LR_MODEMCONFIG3, (RFM96WRead(REG_LR_MODEMCONFIG3) & RFLR_MODEMCONFIG3_AGCAUTO_MASK | RFLR_MODEMCONFIG3_AGCAUTO_ON));
