...
#define McuLib_CONFIG_NXP_SDK_USED ((McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_KINETIS_1_3) || (McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_KINETIS_2_0) || (McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_MCUXPRESSO_2_0) || (McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_S32K))
/*!< Using one of the Freescale/NXP SDKs */

#define McuLib_CONFIG_NXP_SDK_2_0_USED ((McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_KINETIS_2_0) || (McuLib_CONFIG_SDK_VERSION_USED == McuLib_CONFIG_SDK_MCUXPRESSO_2_0))
