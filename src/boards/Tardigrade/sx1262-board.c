...
void SX126xReset( void )
{
    ...
    DelayMs( 20 );
	GpioInit( &SX126x.Reset, RADIO_RESET_PIN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
    DelayMs( 10 );
}
...
{
    GpioInit( &AntPow, RADIO_ANT_SWITCH_PIN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
}
