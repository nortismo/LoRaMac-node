...
- pin_list:
  ...
  - {pin_num: '64', peripheral: GPIO, signal: 'PIO1, 18', pin_signal: PIO1_18/SCT0_OUT5/PLU_OUT0, mode: inactive, slew_rate: standard, invert: disabled, open_drain: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- pin_list:
  ...
  - {pin_num: '94', peripheral: FLEXCOMM0, signal: TXD_SCL_MISO_WS, pin_signal: PIO0_30/FC0_TXD_SCL_MISO_WS/CTIMER0_MAT0/SCT0_OUT9/SECURE_GPIO0_30, mode: pullDown,
  ...
  - {pin_num: '76', peripheral: GPIO, signal: 'PIO0, 21', pin_signal: PIO0_21/FC3_RTS_SCL_SSEL1/UTICK_CAP3/CTIMER3_MAT3/SCT_GPI3/FC7_SCK/HS_SPI_SSEL3/PLU_CLKIN/SECURE_GPIO0_21,
    mode: pullDown, slew_rate: standard, invert: disabled, open_drain: disabled}
  - {pin_num: '2', peripheral: GPIO, signal: 'PIO1, 13', pin_signal: PIO1_13/FC6_RXD_SDA_MOSI_DATA/CT_INP6/USB0_OVERCURRENTN/USB0_FRAME, mode: pullDown, slew_rate: standard,
    invert: disabled, open_drain: disabled}
  - {pin_num: '91', peripheral: GPIO, signal: 'PIO1, 31', pin_signal: PIO1_31/MCLK/CTIMER0_MAT2/SCT0_OUT6/PLU_IN0, mode: pullDown, slew_rate: standard, invert: disabled,
    open_drain: disabled}
  - {pin_num: '66', peripheral: GPIO, signal: 'PIO0, 28', pin_signal: PIO0_28/FC0_SCK/CT_INP11/SCT0_OUT7/USB0_OVERCURRENTN/PLU_OUT1/SECURE_GPIO0_28, mode: pullDown,
    slew_rate: standard, invert: disabled, open_drain: disabled}
  - {pin_num: '67', peripheral: GPIO, signal: 'PIO1, 12', pin_signal: PIO1_12/FC6_SCK/CTIMER1_MAT1/USB0_PORTPWRN/HS_SPI_SSEL2, mode: pullDown, slew_rate: standard,
    invert: disabled, open_drain: disabled}
  - {pin_num: '80', peripheral: GPIO, signal: 'PIO1, 29', pin_signal: PIO1_29/FC7_RXD_SDA_MOSI_DATA/SCT_GPI6/USB1_PORTPWRN/USB1_FRAME/PLU_IN2, mode: pullDown, slew_rate: standard,
    invert: disabled, open_drain: disabled}
  - {pin_num: '65', peripheral: GPIO, signal: 'PIO1, 30', pin_signal: PIO1_30/FC7_TXD_SCL_MISO_WS/SCT_GPI7/USB1_OVERCURRENTN/USB1_LEDN/PLU_IN1, mode: pullDown, slew_rate: standard,
    invert: disabled, open_drain: disabled}
  - {pin_num: '41', peripheral: GPIO, signal: 'PIO1, 22', pin_signal: PIO1_22/CTIMER2_MAT3/SCT_GPI5/FC4_SSEL3/PLU_OUT4/CAN0_RD, mode: pullDown, slew_rate: standard,
    invert: disabled, open_drain: disabled}
  - {pin_num: '73', peripheral: GPIO, signal: 'PIO1, 28', pin_signal: PIO1_28/FC7_SCK/CT_INP2/PLU_IN3, mode: pullDown, slew_rate: standard, invert: disabled, open_drain: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void manage_evk_io_optimization(void)
{
    ...
    const uint32_t FC7_I2S_WS = (/* Pin is configured as PIO0_19 */
                                 IOCON_PIO_FUNC0 |
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_WS_PORT, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_WS_PIN, FC7_I2S_WS);

    const uint32_t FC7_I2S_TX = (/* Pin is configured as PIO0_20 */
                                 IOCON_PIO_FUNC0 |
                                 /* Selects pull-down function */
                                 IOCON_PIO_MODE_PULLDOWN |
                                 /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_TX_PORT, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_TX_PIN, FC7_I2S_TX);

    const uint32_t FC7_I2S_BCLK = (/* Pin is configured as PIO0_21 */
                                   IOCON_PIO_FUNC0 |
                                   /* Selects pull-down function */
                                   IOCON_PIO_MODE_PULLDOWN |
                                   /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_BCLK_PORT, MANAGE_EVK_IO_OPTIMIZATION_FC7_I2S_BCLK_PIN, FC7_I2S_BCLK);
    ...
    const uint32_t FC6_I2S_RX = (/* Pin is configured as PIO1_13 */
                                 IOCON_PIO_FUNC0 |
                                 /* Selects pull-down function */
                                 IOCON_PIO_MODE_PULLDOWN |
                                 /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_FC6_I2S_RX_PORT, MANAGE_EVK_IO_OPTIMIZATION_FC6_I2S_RX_PIN, FC6_I2S_RX);

    const uint32_t CAN_RXD = (/* Pin is configured as PIO1_22 */
                              IOCON_PIO_FUNC0 |
                              /* Selects pull-down function */
                              IOCON_PIO_MODE_PULLDOWN |
                              /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_CAN_RXD_PORT, MANAGE_EVK_IO_OPTIMIZATION_CAN_RXD_PIN, CAN_RXD);
    ...
    const uint32_t I2S_MCLK = (/* Pin is configured as PIO1_31 */
                               IOCON_PIO_FUNC0 |
                               /* Selects pull-down function */
                               IOCON_PIO_MODE_PULLDOWN |
                               /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_I2S_MCLK_PORT, MANAGE_EVK_IO_OPTIMIZATION_I2S_MCLK_PIN, I2S_MCLK);
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_LED_BLUE_PORT, MANAGE_EVK_IO_OPTIMIZATION_LED_BLUE_PIN, LED_BLUE);
    ...
    IOCON_PinMuxSet(IOCON, MANAGE_EVK_IO_OPTIMIZATION_LED_GREEN_PORT, MANAGE_EVK_IO_OPTIMIZATION_LED_GREEN_PIN, LED_GREEN);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
